...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n  --main-color: #ecf87f;\n  --contrast-color: #a6e2dc;\n  --side-color: #97d49b;\n  --text-color: black;\n  --additional-color: #e4a58f;\n  --padding: 2rem;\n  --padding-item: 0.25rem;\n  --padding-grid: 0.75rem;\n  --border-radius: 5px;\n  --font: \"Roboto\", sans-serif;\n}\n\n* {\n  margin: 0;\n  padding: 0;\n  font-family: var(--font);\n}\n\nhtml,\nbody {\n  height: 100%;\n}\n\n.container {\n  height: 100%;\n  display: grid;\n  grid-template-columns: auto minmax(0, 1fr);\n  grid-template-rows: auto 1fr auto;\n  grid-template-areas:\n    \"header header\"\n    \"nav main\"\n    \"footer footer\";\n}\n\nheader {\n  grid-area: header;\n}\n\nheader,\nfooter {\n  display: flex;\n  flex-direction: row;\n  flex-shrink: 0;\n  padding: 1rem;\n  text-align: center;\n  background-color: var(--contrast-color);\n  color: var(--text-color);\n}\n\nh1 {\n  margin: auto;\n}\n\n.footer {\n  grid-area: footer;\n  justify-content: space-between;\n  font-size: smaller;\n}\n\nh2,\ncaption {\n  text-align: center;\n  font-size: medium;\n  padding-bottom: var(--padding-item);\n  border-bottom: #ddd 1px solid;\n}\n\nnav {\n  grid-area: nav;\n  display: flex;\n  flex-direction: column;\n  padding: var(--padding);\n  background-color: var(--side-color);\n}\n\n.item {\n  padding: var(--padding-item);\n  margin-bottom: var(--padding-item);\n}\n\n.bottom {\n  margin-top: auto;\n}\n\n.smallBtn {\n  font-size: 11px;\n  font-weight: 700;\n  background-color: var(--additional-color);\n}\n\nli {\n  list-style: none;\n}\n\nbutton {\n  font-size: small;\n  background-color: var(--main-color);\n  background-repeat: no-repeat;\n  background-position: center;\n  color: var(--text-color);\n  border: none;\n  border-radius: var(--border-radius);\n  padding: 0.5rem;\n  cursor: pointer;\n}\n\nmain {\n  grid-area: main;\n  display: flex;\n  flex-direction: column;\n  flex: 3;\n  flex: 1 0 auto;\n  padding: var(--padding);\n  background-color: var(--main-color);\n}\n\nform {\n  display: flex;\n  flex-direction: column;\n  gap: var(--padding-item);\n}\n\ninput {\n  border: 1px solid var(--text-color);\n  border-radius: var(--border-radius);\n  color: var(--text-color);\n  padding: var(--padding-item);\n  margin-bottom: var(--padding-item);\n}\n\ntable {\n  table-layout: auto;\n  width: 100%;\n  padding-bottom: var(--padding);\n}\n\nth {\n  text-align: left;\n  font-size: smaller;\n  padding: 1rem;\n  border-bottom: 1px solid #ddd;\n}\n\ntr {\n  text-align: center;\n}\n\ntd {\n  overflow: hidden;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n  text-align: left;\n  padding: 1rem;\n  border-bottom: 1px solid #ddd;\n}\n\nimg {\n  width: 15px;\n  height: 15px;\n}\n\n.projectContainer {\n  display: flex;\n  flex-direction: row;\n  gap: var(--padding-item);\n  padding-top: var(--padding-item);\n  padding-bottom: var(--padding-item);\n}\n\n#project {\n  padding: var(--padding-item);\n}\n\n.error {\n  display: none;\n}\n\n#inputModal {\n  /* display: block; */\n  display: none;\n  position: fixed;\n  z-index: 1;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  overflow: auto;\n  background-color: rgba(0, 0, 0, 0.4);\n}\n\n.modalContainer {\n  background-color: #fefefe;\n  margin: 15% auto;\n  padding: var(--padding);\n  border: 1px solid #888;\n  border-radius: var(--border-radius);\n  width: 80%;\n  max-width: 500px;\n}\n\n.hidden {\n  display: none;\n}\n\n#btnContainer {\n  display: flex;\n  flex-direction: row;\n  gap: var(--padding);\n  justify-content: center;\n  padding-top: var(--padding-item);\n}\n\n#btnOpen {\n  background-color: var(--side-color);\n}\n\n.btnClose {\n  color: #aaa;\n  /* float: right; */\n  font-size: small;\n  font-weight: bold;\n}\n\n#btnClose:hover,\n#btnClose:focus {\n  color: black;\n  text-decoration: none;\n  cursor: pointer;\n}\n\n#viewAllBtn {\n  display: block;\n  margin: 0 auto;\n}\n/* project name needs break if too long */\n\n#popupModal {\n  /* display: block; */\n  display: none;\n  position: fixed;\n  z-index: 1;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  overflow: auto;\n  background-color: rgba(0, 0, 0, 0.4);\n}\n\n#popupContainer {\n  display: grid;\n  /* grid-template-columns: repeat(4, auto);\n  grid-template-rows: repeat(6, auto); */\n  /* gap: 1rem; */\n  grid-template-areas:\n    \"labelProject  ...........   ........... ...........\"\n    \"todoProject   todoProject   todoProject labelCompleted\"\n    \"labelName     ...........   ........... todoCompleted\"\n    \"todoName      todoName      todoName    labelPriority\"\n    \"labelDetails  ...........   ........... todoPriority\"\n    \"todoDetails   todoDetails   todoDetails todoDetails\"\n    \"todoDetails   todoDetails   todoDetails todoDetails\"\n    \"labelCreated  ...........   ........... ...........\"\n    \"todoCreatedOn todoCreatedOn ........... ...........\"\n    \"labelDue      ...........   ........... ...........\"\n    \"todoDueDate   todoDueDate   ........... todoDelete\";\n  align-content: end;\n  justify-items: start;\n}\n\n/* align and justify all popup elements */\n#popupContainer > * {\n  align-self: center;\n  justify-self: start;\n}\n\n.popupItemCont {\n  align-self: start;\n}\n\n.label {\n  font-size: xx-small;\n  padding-top: var(--padding-grid);\n}\n\n#todoProject {\n  grid-area: todoProject;\n  grid-column: span 3;\n  font-size: larger;\n  /* padding-bottom: var(--padding-grid); */\n  text-align: center;\n}\n\n#labelCompleted {\n  grid-area: labelCompleted;\n}\n\n#labelName {\n  grid-area: labelName;\n}\n\n#labelDetails {\n  grid-area: labelDetails;\n}\n\n#labelProject {\n  grid-area: labelProject;\n}\n\n#popupName {\n  grid-area: todoName;\n  grid-column: span 3;\n  /* padding-bottom: var(--padding-grid); */\n}\n\n#popupDetails {\n  grid-area: todoDetails;\n  grid-column: span 3;\n  grid-row: span 2;\n  /* padding-bottom: var(--padding-grid); */\n}\n\n#labelCreated {\n  grid-area: labelCreated;\n}\n\n#todoCreatedOn {\n  grid-area: todoCreatedOn;\n  /* padding-bottom: var(--padding-grid); */\n}\n\n#labelDue {\n  grid-area: labelDue;\n}\n\n#popupDueDate {\n  grid-area: todoDueDate;\n}\n\n#labelPriority {\n  grid-area: labelPriority;\n}\n\n#todoPriority {\n  grid-area: todoPriority;\n}\n\n#todoCompleted {\n  grid-area: todoCompleted;\n}\n\n#todoDelete {\n  grid-area: todoDelete;\n  justify-self: end;\n}\n\ninput .completedInput {\n  margin: 0;\n}\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,qBAAqB;EACrB,yBAAyB;EACzB,qBAAqB;EACrB,mBAAmB;EACnB,2BAA2B;EAC3B,eAAe;EACf,uBAAuB;EACvB,uBAAuB;EACvB,oBAAoB;EACpB,4BAA4B;AAC9B;;AAEA;EACE,SAAS;EACT,UAAU;EACV,wBAAwB;AAC1B;;AAEA;;EAEE,YAAY;AACd;;AAEA;EACE,YAAY;EACZ,aAAa;EACb,0CAA0C;EAC1C,iCAAiC;EACjC;;;mBAGiB;AACnB;;AAEA;EACE,iBAAiB;AACnB;;AAEA;;EAEE,aAAa;EACb,mBAAmB;EACnB,cAAc;EACd,aAAa;EACb,kBAAkB;EAClB,uCAAuC;EACvC,wBAAwB;AAC1B;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,iBAAiB;EACjB,8BAA8B;EAC9B,kBAAkB;AACpB;;AAEA;;EAEE,kBAAkB;EAClB,iBAAiB;EACjB,mCAAmC;EACnC,6BAA6B;AAC/B;;AAEA;EACE,cAAc;EACd,aAAa;EACb,sBAAsB;EACtB,uBAAuB;EACvB,mCAAmC;AACrC;;AAEA;EACE,4BAA4B;EAC5B,kCAAkC;AACpC;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,eAAe;EACf,gBAAgB;EAChB,yCAAyC;AAC3C;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,gBAAgB;EAChB,mCAAmC;EACnC,4BAA4B;EAC5B,2BAA2B;EAC3B,wBAAwB;EACxB,YAAY;EACZ,mCAAmC;EACnC,eAAe;EACf,eAAe;AACjB;;AAEA;EACE,eAAe;EACf,aAAa;EACb,sBAAsB;EACtB,OAAO;EACP,cAAc;EACd,uBAAuB;EACvB,mCAAmC;AACrC;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,wBAAwB;AAC1B;;AAEA;EACE,mCAAmC;EACnC,mCAAmC;EACnC,wBAAwB;EACxB,4BAA4B;EAC5B,kCAAkC;AACpC;;AAEA;EACE,kBAAkB;EAClB,WAAW;EACX,8BAA8B;AAChC;;AAEA;EACE,gBAAgB;EAChB,kBAAkB;EAClB,aAAa;EACb,6BAA6B;AAC/B;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,gBAAgB;EAChB,mBAAmB;EACnB,uBAAuB;EACvB,gBAAgB;EAChB,aAAa;EACb,6BAA6B;AAC/B;;AAEA;EACE,WAAW;EACX,YAAY;AACd;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,wBAAwB;EACxB,gCAAgC;EAChC,mCAAmC;AACrC;;AAEA;EACE,4BAA4B;AAC9B;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,oBAAoB;EACpB,aAAa;EACb,eAAe;EACf,UAAU;EACV,OAAO;EACP,MAAM;EACN,WAAW;EACX,YAAY;EACZ,cAAc;EACd,oCAAoC;AACtC;;AAEA;EACE,yBAAyB;EACzB,gBAAgB;EAChB,uBAAuB;EACvB,sBAAsB;EACtB,mCAAmC;EACnC,UAAU;EACV,gBAAgB;AAClB;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,mBAAmB;EACnB,uBAAuB;EACvB,gCAAgC;AAClC;;AAEA;EACE,mCAAmC;AACrC;;AAEA;EACE,WAAW;EACX,kBAAkB;EAClB,gBAAgB;EAChB,iBAAiB;AACnB;;AAEA;;EAEE,YAAY;EACZ,qBAAqB;EACrB,eAAe;AACjB;;AAEA;EACE,cAAc;EACd,cAAc;AAChB;AACA,yCAAyC;;AAEzC;EACE,oBAAoB;EACpB,aAAa;EACb,eAAe;EACf,UAAU;EACV,OAAO;EACP,MAAM;EACN,WAAW;EACX,YAAY;EACZ,cAAc;EACd,oCAAoC;AACtC;;AAEA;EACE,aAAa;EACb;wCACsC;EACtC,eAAe;EACf;;;;;;;;;;;wDAWsD;EACtD,kBAAkB;EAClB,oBAAoB;AACtB;;AAEA,yCAAyC;AACzC;EACE,kBAAkB;EAClB,mBAAmB;AACrB;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,mBAAmB;EACnB,gCAAgC;AAClC;;AAEA;EACE,sBAAsB;EACtB,mBAAmB;EACnB,iBAAiB;EACjB,yCAAyC;EACzC,kBAAkB;AACpB;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,oBAAoB;AACtB;;AAEA;EACE,uBAAuB;AACzB;;AAEA;EACE,uBAAuB;AACzB;;AAEA;EACE,mBAAmB;EACnB,mBAAmB;EACnB,yCAAyC;AAC3C;;AAEA;EACE,sBAAsB;EACtB,mBAAmB;EACnB,gBAAgB;EAChB,yCAAyC;AAC3C;;AAEA;EACE,uBAAuB;AACzB;;AAEA;EACE,wBAAwB;EACxB,yCAAyC;AAC3C;;AAEA;EACE,mBAAmB;AACrB;;AAEA;EACE,sBAAsB;AACxB;;AAEA;EACE,wBAAwB;AAC1B;;AAEA;EACE,uBAAuB;AACzB;;AAEA;EACE,wBAAwB;AAC1B;;AAEA;EACE,qBAAqB;EACrB,iBAAiB;AACnB;;AAEA;EACE,SAAS;AACX","sourcesContent":[":root {\n  --main-color: #ecf87f;\n  --contrast-color: #a6e2dc;\n  --side-color: #97d49b;\n  --text-color: black;\n  --additional-color: #e4a58f;\n  --padding: 2rem;\n  --padding-item: 0.25rem;\n  --padding-grid: 0.75rem;\n  --border-radius: 5px;\n  --font: \"Roboto\", sans-serif;\n}\n\n* {\n  margin: 0;\n  padding: 0;\n  font-family: var(--font);\n}\n\nhtml,\nbody {\n  height: 100%;\n}\n\n.container {\n  height: 100%;\n  display: grid;\n  grid-template-columns: auto minmax(0, 1fr);\n  grid-template-rows: auto 1fr auto;\n  grid-template-areas:\n    \"header header\"\n    \"nav main\"\n    \"footer footer\";\n}\n\nheader {\n  grid-area: header;\n}\n\nheader,\nfooter {\n  display: flex;\n  flex-direction: row;\n  flex-shrink: 0;\n  padding: 1rem;\n  text-align: center;\n  background-color: var(--contrast-color);\n  color: var(--text-color);\n}\n\nh1 {\n  margin: auto;\n}\n\n.footer {\n  grid-area: footer;\n  justify-content: space-between;\n  font-size: smaller;\n}\n\nh2,\ncaption {\n  text-align: center;\n  font-size: medium;\n  padding-bottom: var(--padding-item);\n  border-bottom: #ddd 1px solid;\n}\n\nnav {\n  grid-area: nav;\n  display: flex;\n  flex-direction: column;\n  padding: var(--padding);\n  background-color: var(--side-color);\n}\n\n.item {\n  padding: var(--padding-item);\n  margin-bottom: var(--padding-item);\n}\n\n.bottom {\n  margin-top: auto;\n}\n\n.smallBtn {\n  font-size: 11px;\n  font-weight: 700;\n  background-color: var(--additional-color);\n}\n\nli {\n  list-style: none;\n}\n\nbutton {\n  font-size: small;\n  background-color: var(--main-color);\n  background-repeat: no-repeat;\n  background-position: center;\n  color: var(--text-color);\n  border: none;\n  border-radius: var(--border-radius);\n  padding: 0.5rem;\n  cursor: pointer;\n}\n\nmain {\n  grid-area: main;\n  display: flex;\n  flex-direction: column;\n  flex: 3;\n  flex: 1 0 auto;\n  padding: var(--padding);\n  background-color: var(--main-color);\n}\n\nform {\n  display: flex;\n  flex-direction: column;\n  gap: var(--padding-item);\n}\n\ninput {\n  border: 1px solid var(--text-color);\n  border-radius: var(--border-radius);\n  color: var(--text-color);\n  padding: var(--padding-item);\n  margin-bottom: var(--padding-item);\n}\n\ntable {\n  table-layout: auto;\n  width: 100%;\n  padding-bottom: var(--padding);\n}\n\nth {\n  text-align: left;\n  font-size: smaller;\n  padding: 1rem;\n  border-bottom: 1px solid #ddd;\n}\n\ntr {\n  text-align: center;\n}\n\ntd {\n  overflow: hidden;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n  text-align: left;\n  padding: 1rem;\n  border-bottom: 1px solid #ddd;\n}\n\nimg {\n  width: 15px;\n  height: 15px;\n}\n\n.projectContainer {\n  display: flex;\n  flex-direction: row;\n  gap: var(--padding-item);\n  padding-top: var(--padding-item);\n  padding-bottom: var(--padding-item);\n}\n\n#project {\n  padding: var(--padding-item);\n}\n\n.error {\n  display: none;\n}\n\n#inputModal {\n  /* display: block; */\n  display: none;\n  position: fixed;\n  z-index: 1;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  overflow: auto;\n  background-color: rgba(0, 0, 0, 0.4);\n}\n\n.modalContainer {\n  background-color: #fefefe;\n  margin: 15% auto;\n  padding: var(--padding);\n  border: 1px solid #888;\n  border-radius: var(--border-radius);\n  width: 80%;\n  max-width: 500px;\n}\n\n.hidden {\n  display: none;\n}\n\n#btnContainer {\n  display: flex;\n  flex-direction: row;\n  gap: var(--padding);\n  justify-content: center;\n  padding-top: var(--padding-item);\n}\n\n#btnOpen {\n  background-color: var(--side-color);\n}\n\n.btnClose {\n  color: #aaa;\n  /* float: right; */\n  font-size: small;\n  font-weight: bold;\n}\n\n#btnClose:hover,\n#btnClose:focus {\n  color: black;\n  text-decoration: none;\n  cursor: pointer;\n}\n\n#viewAllBtn {\n  display: block;\n  margin: 0 auto;\n}\n/* project name needs break if too long */\n\n#popupModal {\n  /* display: block; */\n  display: none;\n  position: fixed;\n  z-index: 1;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  overflow: auto;\n  background-color: rgba(0, 0, 0, 0.4);\n}\n\n#popupContainer {\n  display: grid;\n  /* grid-template-columns: repeat(4, auto);\n  grid-template-rows: repeat(6, auto); */\n  /* gap: 1rem; */\n  grid-template-areas:\n    \"labelProject  ...........   ........... ...........\"\n    \"todoProject   todoProject   todoProject labelCompleted\"\n    \"labelName     ...........   ........... todoCompleted\"\n    \"todoName      todoName      todoName    labelPriority\"\n    \"labelDetails  ...........   ........... todoPriority\"\n    \"todoDetails   todoDetails   todoDetails todoDetails\"\n    \"todoDetails   todoDetails   todoDetails todoDetails\"\n    \"labelCreated  ...........   ........... ...........\"\n    \"todoCreatedOn todoCreatedOn ........... ...........\"\n    \"labelDue      ...........   ........... ...........\"\n    \"todoDueDate   todoDueDate   ........... todoDelete\";\n  align-content: end;\n  justify-items: start;\n}\n\n/* align and justify all popup elements */\n#popupContainer > * {\n  align-self: center;\n  justify-self: start;\n}\n\n.popupItemCont {\n  align-self: start;\n}\n\n.label {\n  font-size: xx-small;\n  padding-top: var(--padding-grid);\n}\n\n#todoProject {\n  grid-area: todoProject;\n  grid-column: span 3;\n  font-size: larger;\n  /* padding-bottom: var(--padding-grid); */\n  text-align: center;\n}\n\n#labelCompleted {\n  grid-area: labelCompleted;\n}\n\n#labelName {\n  grid-area: labelName;\n}\n\n#labelDetails {\n  grid-area: labelDetails;\n}\n\n#labelProject {\n  grid-area: labelProject;\n}\n\n#popupName {\n  grid-area: todoName;\n  grid-column: span 3;\n  /* padding-bottom: var(--padding-grid); */\n}\n\n#popupDetails {\n  grid-area: todoDetails;\n  grid-column: span 3;\n  grid-row: span 2;\n  /* padding-bottom: var(--padding-grid); */\n}\n\n#labelCreated {\n  grid-area: labelCreated;\n}\n\n#todoCreatedOn {\n  grid-area: todoCreatedOn;\n  /* padding-bottom: var(--padding-grid); */\n}\n\n#labelDue {\n  grid-area: labelDue;\n}\n\n#popupDueDate {\n  grid-area: todoDueDate;\n}\n\n#labelPriority {\n  grid-area: labelPriority;\n}\n\n#todoPriority {\n  grid-area: todoPriority;\n}\n\n#todoCompleted {\n  grid-area: todoCompleted;\n}\n\n#todoDelete {\n  grid-area: todoDelete;\n  justify-self: end;\n}\n\ninput .completedInput {\n  margin: 0;\n}\n"],"sourceRoot":""}]);
// Exports
  ...
  for (const project in _createTodo__WEBPACK_IMPORTED_MODULE_1__.projectList) {
    ...
    if (project !== 'Completed' && project !== 'My Todos') {
      projectContainer.appendChild(
        createIcon(_edit_png__WEBPACK_IMPORTED_MODULE_4__, () =>
          handleEditProject(project, listItem, projectContainer)
        )
      )
      projectContainer.appendChild(
        createIcon(_recycle_bin_png__WEBPACK_IMPORTED_MODULE_3__, () => handleDeleteProject(project))
      )
    }
...
function addDeleteListener (todo, project) {
  dispTodoDelete.appendChild(
    createIcon(_recycle_bin_png__WEBPACK_IMPORTED_MODULE_3__, () => handleDeleteTodoListener(todo, project))
  )
}
...
function deleteTodo (todo) {
  if (confirm('Are you sure you want to delete this todo?')) {
    let todoProject
    console.log(_createTodo__WEBPACK_IMPORTED_MODULE_1__.projectList[todo.project])
...
// import { projectList } from "./testing"
